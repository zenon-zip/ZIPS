...
4. Connection behavior settings lack explicit defaults
5. Users need more clarity about default values and behavior

This ZIP aims to solve these issues by:
- Formalizing all network configuration options
...
- Centralizing default values in the p2p package
- Adding explicit control over connection behavior
